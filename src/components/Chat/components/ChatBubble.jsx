    ...
    return (
      <div className={bubbleClass}>
        ...
        {message.file ?
          ...
          :
          <div className={message.userName === "dragonKing" ? "chat__bubble-message-wrap-send" : "chat__bubble-message-wrap"}>
            <p className={message.userName === "dragonKing" ? "chat__bubble-contact-name-send" : "chat__bubble-contact-name"}>{contact.name}</p>
            <p className={ message.userName === "dragonKing" ? "chat__bubble-message-send" : "chat__bubble-message"}>{message.message}</p>
            <p className="chat__bubble-date">{moment(message.date).format('LT')}</p>
          </div>
        }
      </div>
