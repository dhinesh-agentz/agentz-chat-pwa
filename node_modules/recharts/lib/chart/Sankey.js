  ...
  _createClass(Sankey, [{
    ...
    value: function componentDidUpdate(prevProps) {
      var data = prevProps.data,
          ...
          iterations = prevProps.iterations,
          nodeWidth = prevProps.nodeWidth,
          nodePadding = prevProps.nodePadding,
          nameKey = prevProps.nameKey;

      if (this.props.data !== data || this.props.width !== width || this.props.height !== height || !(0, _ShallowEqual.shallowEqual)(this.props.margin, margin) || this.props.iterations !== iterations || this.props.nodeWidth !== nodeWidth || this.props.nodePadding !== nodePadding || this.props.nameKey !== nameKey) {
