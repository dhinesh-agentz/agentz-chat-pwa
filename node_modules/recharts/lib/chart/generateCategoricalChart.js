    ...
    _createClass(CategoricalChartWrapper, [{
      ...
      value: function componentDidUpdate(prevProps) {
        ...
        var data = prevProps.data,
            ...
            stackOffset = prevProps.stackOffset,
            margin = prevProps.margin;
        var updateId = this.state.updateId;

        if (this.props.data !== data || this.props.width !== width || this.props.height !== height || this.props.layout !== layout || this.props.stackOffset !== stackOffset || !(0, _ShallowEqual.shallowEqual)(this.props.margin, margin)) {
          var defaultState = this.constructor.createDefaultState(this.props); // eslint-disable-next-line react/no-did-update-set-state
        ...
        } else if (!(0, _ReactUtils.isChildrenEqual)(this.props.children, children)) {
          // update configuration in chilren
          var hasGlobalData = !(0, _isNil2["default"])(this.props.data);
          var newUpdateId = hasGlobalData ? updateId : updateId + 1; // eslint-disable-next-line react/no-did-update-set-state
        ...
        if ((0, _isNil2["default"])(this.props.syncId) && !(0, _isNil2["default"])(this.props.syncId)) {
          this.addListener();
        } // remove syncId
