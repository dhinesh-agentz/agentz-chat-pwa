  ...
  function (_Component) {
    ...
    _createClass(CategoricalChartWrapper, [{
      ...
      value: function componentDidUpdate(prevProps) {
        ...
        if (this.props.data !== data || this.props.width !== width || this.props.height !== height || this.props.layout !== layout || this.props.stackOffset !== stackOffset || !shallowEqual(this.props.margin, margin)) {
          ...
          var hasGlobalData = !_isNil(this.props.data);
        ...
        if (_isNil(this.props.syncId) && !_isNil(this.props.syncId)) {
          this.addListener();
        } // remove syncId
