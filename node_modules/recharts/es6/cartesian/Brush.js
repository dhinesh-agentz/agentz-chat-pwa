  ...
  _createClass(Brush, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      var data = prevProps.data,
          ...
          x = prevProps.x,
          travellerWidth = prevProps.travellerWidth,
          updateId = prevProps.updateId;

      if ((this.props.data !== data || this.props.updateId !== updateId) && this.props.data && this.props.data.length) {
        // eslint-disable-next-line react/no-did-update-set-state
        this.setState(this.updateScale(this.props));
      } else if (this.props.width !== width || this.props.x !== x || this.props.travellerWidth !== travellerWidth) {
